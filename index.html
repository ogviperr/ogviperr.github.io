...
<div id="page-home" class="page active">
  <section class="hero">
    ...
    <div class="hero-content">
      ...
      <p class="hero-title">16-year-old developer • Malaysia • building things that shouldn't exist yet</p>
...
<div id="page-about" class="page">
  <div class="section">
    ...
    <p>16-year-old Malaysian developer passionate about security, AI, web apps, and building cool stuff. Forecasted A-Levels: 5A* 2A 1B.</p>
  </div>
</div>
